...
| Home | Drink |
| ---- | ---- |
| ![Homeページ](README_images/index.png) | ![Drinkページ](README_images/drink_page.png) |
| Cafe RecursionのHome画面です。 | ドリンクのメニューが載っているページです |

| Sweets | Food | Information |
| ---- | ---- | ---- |
| ![Sweetsページ](README_images/sweets_page.png) | ![Foodページ](README_images/food_page.png) | ![Informationページ](README_images/information_page.png) |
